...
@file
@author F. Aubert
@brief op�rations sur les quaternions (w,(x,y,z))
@brief op�rations sur les quaternions (w,(x,y,z))
*/
...
/**
@class Quaternion
@brief repr�sentation des quaternions (w,(x,y,z))
*/
class Quaternion {
  double _w,_x,_y,_z;
...
public:
  ...
  void copyToAngleAxis(double *angle,Vector3 *u);
  ...
  /// returns the matrix that corresponds to the quaternion
  ...
  friend Quaternion quaternion(const Matrix4 &m);

  static Quaternion identity();
  static Quaternion rotation(double angle,const Vector3 &u);
