...
class WEdge
{
  public:
    ...
    const prog3d::Vector3 &vector() const;
    prog3d::Vector3 direction();
    const prog3d::Vector3 &pointEdge() const;
    prog3d::Vector3 midPoint();
  ...
  prog3d::Vector3 _vector;
  prog3d::Vector3 _pointEdge;
