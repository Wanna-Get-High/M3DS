...
static QFont *_fontQt;
    ...
    static void drawGround(const prog3d::Texture &texture);
    ...
    static void addDebug(const Vector3 &p,const std::string &,const Color &color=Vector3(1,0,0),const Vector3 &decal=Vector3(0.1,0.1,0.0));
    /// permset de mémoriser le segment AB
    static void addDebug(const Vector3 &a,const Vector3 &b,const std::string &mesg="",const Color &color=Vector3(1,0,0));

    /// enlève tous les points mémorisés dans la liste
    static void debugClear();

    ///
    static void errorQuery(const std::string &mesg);
