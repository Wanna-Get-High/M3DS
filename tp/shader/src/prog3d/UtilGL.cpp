...
QGLWidget *UtilGL::_widgetQt;
QFont *UtilGL::_fontQt;
...
void UtilGL::drawGrid() {
  ...
  float pasX;
  float pasY;
  float demiLongueur=10;  // les coordonnées varient entre -2 et 2 (taille de la grille en (x,y) est 4 x 4.
...
void UtilGL::errorQuery(const string &mesg) {
  cout << "==============================" << endl;
